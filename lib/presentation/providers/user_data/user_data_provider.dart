...
import 'package:flix_id/presentation/providers/transaction_data/transactions_data_provider.dart';
  ...
  Future<void> topUp(int amount) async {
    ...
    if (userId != null) {
      ...
      if (result is Success) {
        refreshUserData();
        ref.read(transactionsDataProvider.notifier).refreshTransactionData();
      }
    }
  }
